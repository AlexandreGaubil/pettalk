...
func displayImage(imageNumber: Int, scrollViewHeight: Int, scrollViewWidth: Int) -> UIView {
    ...
    //COORDINATES
    let xCoordinateMessage = returnxCoordinateOfMessage(sentBy: Sender.pet)
    ...
    if imageTypeArray[imageNumber] == "img" {
        newMessageView.layer.backgroundColor = backroundColorOfMessage(sentBy: Sender.pet).cgColor
    }
